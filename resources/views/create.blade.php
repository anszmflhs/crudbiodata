...
<body>
    <div class="w-full max-w-3xl mx-auto p-8">
        <h1 class="text-2xl font-bold text-gray-800 mb-4">Halaman Create</h1>
        <form method="POST" action="{{ route('biodata.store') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="name">
                    Name:
                </label>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" placeholder="Nama">
            </div>
            <div class="mb-6">
